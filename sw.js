// Service Worker for 2026 台鐵時刻表 PWA (v3.9.31)
const CACHE_NAME = 'tra-timetable-pwa-v3.9.31';
const RUNTIME_CACHE = 'tra-runtime-v3.9.31';
...
self.addEventListener('install', (event) => {
  ...
  event.waitUntil(
    caches.open(CACHE_NAME).then((cache) => {
      console.log('[SW] Pre-caching core app assets for offline use (v3.9.31)...');
