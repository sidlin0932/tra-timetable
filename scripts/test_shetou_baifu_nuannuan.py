...
const r = sandbox.planMultiStopRoutes(wps, 0);
console.log('Total Multi-Stop (社頭 -> 百福 -> 暖暖) routes:', r.length);
if (r.length === 0) throw new Error('Multi-stop routes returned 0!');
...
console.log('MULTI-STOP TEST PASS 100%!');
"""
