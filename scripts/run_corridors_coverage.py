...
with open('scripts/test_taiwan_corridors_coverage.js', 'w', encoding='utf-8') as f:
    f.write(test_js)

res = subprocess.run(["node", "scripts/test_taiwan_corridors_coverage.js"], capture_output=True, text=True, encoding="utf-8")
print(res.stdout)
