# -*- coding: utf-8 -*-
"""
Adds lightweight, ultra-fast 17-county Station Picker Modal to lite.html.
Bumps to v3.9.11 across all files.
"""
...
<body>
        ...
        <div class="station-grid">
            <div class="input-group">
                ...
                <div class="input-box-wrapper">
                    ...
                    <button class="btn-modal-trigger" onclick="openPicker('orig')">🗺️ 選站</button>
            ...
            <div class="input-group">
                ...
                <div class="input-box-wrapper">
                    ...
                    <button class="btn-modal-trigger" onclick="openPicker('dest')">🗺️ 選站</button>
    ...
    <script src="data.js?v=3.9.11"></script>
    ...
    <script>
        ...
        // ==========================================
        let currentModalTarget = 'orig';
        let currentActiveTab = 'all';

        function openPicker(type) {
            currentModalTarget = type;
            document.getElementById('modalTitle').textContent = `🗺️ 請點選【${type === 'orig' ? '起點' : '終點'}】車站`;
        ...
        function modalPick(st) {
            setStation(currentModalTarget, st);
            closeModalDirect();
            if (currentModalTarget === 'orig') {
                // If picking origin, auto open destination modal
                setTimeout(() => openPicker('dest'), 80);
            }
        }
...
with open(INDEX_HTML, "r", encoding="utf-8") as f:
    html = f.read()
html = re.sub(r'v3\.9\.\d+', 'v3.9.11', html)
html = html.replace('data.js?v=3.9.10', 'data.js?v=3.9.11')
...
with open(SW_JS, "r", encoding="utf-8") as f:
    sw = f.read()
sw = re.sub(r'v3\.9\.\d+', 'v3.9.11', sw)
sw = re.sub(r'tra-timetable-pwa-v\d+', 'tra-timetable-pwa-v3911', sw)
sw = re.sub(r'tra-runtime-v\d+', 'tra-runtime-v3911', sw)
...
V3911_CHANGELOG = """## [v3.9.11] - 2026-08-25
...
with open(BUILD_SCRIPT, "r", encoding="utf-8") as f:
    bld = f.read()
if '{"version": "v3.9.11"' not in bld:
    bld = bld.replace('HISTORICAL_COMMITS = [', 'HISTORICAL_COMMITS = [\n    {"version": "v3.9.11", "commit": "HEAD",    "date": "2026-08-25", "desc": "極速極簡版 SuperLite 導入 17 縣市視覺化選站彈窗"},')
    with open(BUILD_SCRIPT, "w", encoding="utf-8") as f:
        f.write(bld)

print("v3.9.11 applied successfully!")
