...
<body>
    ...
    <header>
        <div class="brand">
            <span>🚆 台鐵時刻表</span>
            <span class="badge-lite">⚡ SuperLite 極速極簡版 v3.9.14-lite</span>
        </div>
    ...
    <script src="data.js?v=3.9.14"></script>
    ...
    <script>
        ...
        function planMultiStop(wps, startMin, transferMax, typeF) {
            ...
            let candidateChains = planLeg(wps[0].station, wps[1].station, startMin, transferMax, typeF).slice(0, 8);
            ...
            candidateChains.sort((a, b) => a.arrMin - b.arrMin);
